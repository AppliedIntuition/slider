  ...
  return _temp = _class = function (_Component) {
    ...
    (0, _createClass3['default'])(ComponentEnhancer, [{
      ...
      value: function addDocumentTouchEvents() {
        ...
        this.onTouchMoveListener = (0, _addEventListener2['default'])(this.document, 'touchmove', this.onTouchMove, { capture: true });
        this.onTouchUpListener = (0, _addEventListener2['default'])(this.document, 'touchend', this.onEnd, { capture: true });
      }
    }, {
      ...
      value: function addDocumentMouseEvents() {
        // Capture phase so drag-end fires before a portal/overlay stopPropagation in the bubble phase
        // can swallow it (e.g. rc-slider rendered inside a portaled Modal).
        this.onMouseMoveListener = (0, _addEventListener2['default'])(this.document, 'mousemove', this.onMouseMove, { capture: true });
        this.onMouseUpListener = (0, _addEventListener2['default'])(this.document, 'mouseup', this.onEnd, { capture: true });
      }
    }, {
